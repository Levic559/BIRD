function BtnPagesUI (circleTwo="#9A9999", circleThree="#9A9999", lastPage="../General_info_structure/General-info-1.html", nextPage="../General_info_structure/General-info-1.html")
{
    return`
        <div style="
            display: flex;
